...
<head>
	<base href="../" />
	<title>Leaves (Employee) - Employee Portal</title>
	<meta charset="utf-8" />
						...
						<div class="d-flex flex-column flex-column-fluid">
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-1 flex-column justify-content-center my-0">Leaves (Employee)</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
											<!--begin::Item-->
											<li class="breadcrumb-item text-muted">
												<a href="../../demo1/dist/index.html" class="text-muted text-hover-primary">Leaves</a>
											</li>
											<!--end::Item-->
											<!--begin::Item-->
											...
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item text-muted">Leaves (Employee)</li>
											<!--end::Item-->
										</ul>
										<!--end::Breadcrumb-->
									</div>
							...
							<div id="kt_app_content" class="app-content flex-column-fluid">
								...
								<div id="kt_app_content_container" class="app-container container-xxl">
									<!--begin::Card-->
									<div class="card">
									<ul class="nav nav-pills d-flex justify-content-around nav-pills-custom gap-3 mb-6" role="tablist">
														<!--begin::Item-->
														<li class="nav-item mb-3 me-0" role="presentation">
															<!--begin::Nav link-->
															<a class="nav-link nav-link-border-solid btn btn-outline btn-flex btn-active-color-primary flex-column flex-stack pt-9 pb-7 page-bg my-4" data-bs-toggle="pill" href="#kt_pos_food_content_1" style="width: 200px;height: 130px" aria-selected="true" role="tab">
																<!--begin::Info-->
																<div class="">
																	<span class="text-gray-800 fw-bold fs-2 d-block">Annual Leaves</span>
																	<span class="text-primary-400 fw-bold fs-5">12</span>
																</div>
																<!--end::Info-->
															</a>
															<!--end::Nav link-->
														...
														<li class="nav-item mb-3 me-0" role="presentation">
															...
															<a class="nav-link nav-link-border-solid btn btn-outline btn-flex btn-active-color-primary flex-column flex-stack pt-9 pb-7 page-bg my-4" data-bs-toggle="pill" href="#kt_pos_food_content_1" style="width: 200px;height: 130px" aria-selected="true" role="tab">
																<!--begin::Info-->
																<div class="">
																	<span class="text-gray-800 fw-bold fs-2 d-block">Monthly Leaves</span>
																	<span class="text-primary-400 fw-bold fs-5">01</span>
																</div>
																<!--end::Info-->
															</a>
															<!--end::Nav link-->
														...
														<li class="nav-item mb-3 me-0" role="presentation">
															...
															<a class="nav-link nav-link-border-solid btn btn-outline btn-flex btn-active-color-primary flex-column flex-stack pt-9 pb-7 page-bg my-4" data-bs-toggle="pill" href="#kt_pos_food_content_1" style="width: 200px;height: 130px" aria-selected="true" role="tab">
																<!--begin::Info-->
																<div class="">
																	<span class="text-gray-800 fw-bold fs-2 d-block">Medical Leaves</span>
																	<span class="text-primary-400 fw-bold fs-5">07</span>
																</div>
																<!--end::Info-->
															</a>
															<!--end::Nav link-->
														...
														<li class="nav-item mb-3 me-0" role="presentation">
															...
															<a class="nav-link nav-link-border-solid btn btn-outline btn-flex btn-active-color-primary flex-column flex-stack pt-9 pb-7 page-bg my-4" data-bs-toggle="pill" href="#kt_pos_food_content_1" style="width: 200px;height: 130px" aria-selected="true" role="tab">
																<!--begin::Info-->
																<div class="">
																	<span class="text-gray-800 fw-bold fs-2 d-block">Remaining leaves</span>
																	<span class="text-primary-400 fw-bold fs-5">2</span>
																</div>
																<!--end::Info-->
															</a>
															<!--end::Nav link-->
