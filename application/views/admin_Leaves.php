...
<head>
	<base href="../" />
	<title>Leaves (Admin) - Employee Portal</title>
	<meta charset="utf-8" />
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-1 flex-column justify-content-center my-0">Leaves (Admin)</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
										<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
											...
											<!--end::Item-->
											<!--begin::Item-->
											<li class="breadcrumb-item text-muted">Leaves (Admin)</li>
											<!--end::Item-->
										</ul>
										<!--end::Breadcrumb-->
									</div>
									...
									<ul class="nav nav-pills d-flex justify-content-around nav-pills-custom gap-3 mb-6" role="tablist">
														...
														<li class="nav-item mb-3 me-0" role="presentation">
															...
															<a class="nav-link nav-link-border-solid btn btn-outline btn-flex btn-active-color-primary flex-column flex-stack pt-9 pb-7 page-bg my-4" data-bs-toggle="pill" href="#kt_pos_food_content_1" style="width: 200px;height: 130px" aria-selected="true" role="tab">
																<!--begin::Info-->
																<div class="">
																	<span class="text-gray-800 fw-bold fs-2 d-block">Today Presents</span>
																	<span class="text-primary-400 fw-bold fs-5">06 / 10</span>
																</div>
																<!--end::Info-->
															</a>
															<!--end::Nav link-->
														...
														<li class="nav-item mb-3 me-0" role="presentation">
															...
															<a class="nav-link nav-link-border-solid btn btn-outline btn-flex btn-active-color-primary flex-column flex-stack pt-9 pb-7 page-bg my-4" data-bs-toggle="pill" href="#kt_pos_food_content_1" style="width: 200px;height: 130px" aria-selected="true" role="tab">
																<!--begin::Info-->
																<div class="">
																	<span class="text-gray-800 fw-bold fs-2 d-block">Planned Leaves</span>
																	<span class="text-primary-400 fw-bold fs-5">02 Today</span>
																</div>
																<!--end::Info-->
															</a>
															<!--end::Nav link-->
														...
														<li class="nav-item mb-3 me-0" role="presentation">
															...
															<a class="nav-link nav-link-border-solid btn btn-outline btn-flex btn-active-color-primary flex-column flex-stack pt-9 pb-7 page-bg my-4" data-bs-toggle="pill" href="#kt_pos_food_content_1" style="width: 200px;height: 130px" aria-selected="true" role="tab">
																<!--begin::Info-->
																<div class="">
																	<span class="text-gray-800 fw-bold fs-2 d-block">Unapproved Leaves</span>
																	<span class="text-primary-400 fw-bold fs-5">02 Today</span>
																</div>
																<!--end::Info-->
															</a>
														...
														<li class="nav-item mb-3 me-0" role="presentation">
															...
															<a class="nav-link nav-link-border-solid btn btn-outline btn-flex btn-active-color-primary flex-column flex-stack pt-9 pb-7 page-bg my-4" data-bs-toggle="pill" href="#kt_pos_food_content_1" style="width: 200px;height: 130px" aria-selected="true" role="tab">
																<!--begin::Info-->
																<div class="">
																	<span class="text-gray-800 fw-bold fs-2 d-block">Pending Requests</span>
																	<span class="text-primary-400 fw-bold fs-5">10</span>
																</div>
																<!--end::Info-->
															</a>
															<!--end::Nav link-->
